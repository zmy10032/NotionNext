...
const BLOG = {
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://github.com/zmy10032/zmy10032.github.io/blob/master/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  WIDGET_PET_LINK:
    ...
    'https://github.com/xiazeyu/live2d-widget-models/tree/master/packages/live2d-widget-model-haru', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
        // 默认https://cdn.jsdelivr.net/npm/live2d-widget-model-wanko@1.0.5/assets/wanko.model.json
